						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<input type="submit" class="btn btn-lg btn-primary btn-block-conf" value="会員登録する">
									<input type="button" class="btn btn-lg btn-primary btn-block-conf" value="修正する" onclick="history.back()">
								</div>
							</div>
						</div>
					</div>
